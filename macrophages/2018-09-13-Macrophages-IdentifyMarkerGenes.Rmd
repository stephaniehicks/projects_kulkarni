...
write.csv(dat, file.path(workingPath, 
                         "markergenes/seurat_macrophagesonly_clust0markers.csv"), 
          quote = FALSE, row.names=TRUE)

pdf(file.path(workingPath, 
              "figs/seurat_macrophagesonly_clust0markers.pdf"), 
    width=12, height=12)
...
write.csv(dat, file.path(workingPath, 
                         "markergenes/seurat_macrophagesonly_clust1markers.csv"), 
          quote = FALSE, row.names=TRUE)

pdf(file.path(workingPath, 
              "figs/seurat_macrophagesonly_clust1markers.pdf"), 
    width=12, height=12)
FeaturePlot(object = trt.combined.macro, features.plot = row.names(dat)[1:20], 
            min.cutoff = "q9", cols.use = c("lightgrey", "blue"), pt.size = 0.5)
dev.off()
